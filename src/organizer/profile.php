          ...
          <form id="registerForm" method="POST" action="">
               <div class="grid md:grid-cols-2 gap-3 space-y-5 space-x-3 justify-center">
                    ...
                    <div>
                         ...
                         <textarea class="py-3 w-full bg-transparent rounded-lg" id="description" name="description" rows="4" placeholder="Describe your services, history, or mission..." ></textarea>
                    </div>
