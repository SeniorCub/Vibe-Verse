...
function generateTicket() {
  ...
  profileImage.src = document.getElementById('file').files[0].name;

  // Set the username, email, and amount
  username.textContent = document.getElementById('uname').value;
  email.textContent = document.getElementById('email').value;
  amount.textContent = document.getElementById('amount').value;
...
// Call the generateTicket function when the download button is clicked
document.querySelector('.download').addEventListener('click', generateTicket);
